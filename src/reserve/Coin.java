...
public class Coin extends DynamicGameObject{
	...
	public static final float COIN_COL_WIDTH = 0.7f;
	public static final float COIN_COL_HEIGHT = 0.7f;
	...
	public static final float GEM_WIDTH = 1.5f;
	public static final float GEM_HEIGHT = 1.5f;
