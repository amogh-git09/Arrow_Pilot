...
public class GameScreen extends GLScreen{
	...
	public GameScreen(Game game, int areaNumber){
		...
		pauseBounds = new Rectangle(800 - 40, 480 - 40, 40, 40);
...
/*	private void updateLevelClear(float deltaTime){
	...
	*/
	...
	private void presentRunning(){
		batcher.drawSprite(800 - 25, 480 - 25, 30, 40, AssetsGameScreen.pauseButton);
		AssetsGameScreen.font.drawText(batcher, scoreString, 20, 480 - 20);
	}
